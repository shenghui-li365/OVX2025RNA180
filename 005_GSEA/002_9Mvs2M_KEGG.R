...
file = list.files("/share/home/shli24/2025OVX/result/DE_result",pattern = "DEgenename2_2Mvs9M")
group <- c("direction","direction_5","direction1","direction1_5","direction2","Direction","Direction_5","Direction1","Direction1_5")
m = "direction"
i = "DEgenename2_2Mvs9M_Liver.txt"
for (i in file){
...
save(KEGG_result,GO,KEGG_top10,GO_top10,file = "All_TOP10_GO_KEGG_9Mvs2M.Rdata")
#load("All_TOP10_GO_KEGG_9Mvs2M.Rdata")
#setwd("/share/home/shli24/2025OVX/result/")
library(ggplot2)
pdf("GO_result/All_9Mvs2M_TOP10_GO.pdf",width = 8 ,height=6.1)
...
pdf("KEGG_result/All_9Mvs2M_TOP10_KEGG.pdf",width = 8 ,height=6.1)
