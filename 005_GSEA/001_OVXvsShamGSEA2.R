...
for (i in tissue) {
  ...
  #geneList <- -log10(DE_results$pvalue) * sign(DE_results$log2FoldChange)
...
pdf("/share/home/shli24/2025OVX/result/r_plot/003_GSEA_ShamvsOVX_FC_all2.pdf",width = 7,height = 5)
...
pdf("/share/home/shli24/2025OVX/result/r_plot/003_GSEA_ShamvsOVX_3_all2.pdf",width = 7,height = 5)
